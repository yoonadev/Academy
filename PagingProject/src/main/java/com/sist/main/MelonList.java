...
public class MelonList extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//타이틀
		out.println("<h1 class=text-center>멜론 Top100</h1>");
		...
		out.println("<th class=text-center>좋아요</th>");
		out.println("</tr>");
		//데이터
		for(MelonVO vo:list) {
			out.println("<tr>");
		...
		out.println("<a href=MelonList?page="+(curpage>1?curpage-1:curpage)+" class=\"btn btn-sm btn-danger\">이전</a>");
		out.println(curpage+" page / "+totalpage+" pages ");
		out.println("<a href=MelonList?page="+(curpage<totalpage?curpage+1:curpage)+" class=\"btn btn-sm btn-success\">다음</a>");
		out.println("</td>");
		out.println("</tr>");
		out.println("<tr>");
		out.println("<td class=text-center>");
